...
public class ArrayIndexedList<T> implements IndexedList<T> {
	...
	private void shiftRight(int index) {
		assert !isFull();
		//does it want a new array with an extra space?
		//the assertion above "not full" detects if there is extra space at end
		//read carefully, you didn't see that it meant all elements from the index
			//parameter to the end, not the entire array
